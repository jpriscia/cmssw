...
namespace {
  ...
  *************************************************/
  ...
  template<int nsigma> class SiStripApvGainsRatioWithPreviousIOVTrackerMapBase : public cond::payloadInspector::PlotImage<SiStripApvGain> {
  public:
    SiStripApvGainsRatioWithPreviousIOVTrackerMapBase() : cond::payloadInspector::PlotImage<SiStripApvGain>( "Tracker Map of ratio of SiStripGains with previous IOV" ){
    }
  ...
  template<int nsigma> class SiStripApvGainsRatioWithPreviousIOVTrackerMapSingleTag : public SiStripApvGainsRatioWithPreviousIOVTrackerMapBase<nsigma> {
  public:
    SiStripApvGainsRatioWithPreviousIOVTrackerMapSingleTag(): SiStripApvGainsRatioWithPreviousIOVTrackerMapBase<nsigma>(){
      this->setSingleIov (false);
    }
  };

  template<int nsigma> class SiStripApvGainsRatioWithPreviousIOVTrackerMapTwoTags : public SiStripApvGainsRatioWithPreviousIOVTrackerMapBase <nsigma> {
  public:
    SiStripApvGainsRatioWithPreviousIOVTrackerMapTwoTags(): SiStripApvGainsRatioWithPreviousIOVTrackerMapBase<nsigma>(){
      this->setTwoTags(true);
    }
  };


  typedef SiStripApvGainsRatioWithPreviousIOVTrackerMapSingleTag<1> SiStripApvGainsAvgDeviationRatio1sigmaTrackerMapSingleTag;
  typedef SiStripApvGainsRatioWithPreviousIOVTrackerMapSingleTag<2> SiStripApvGainsAvgDeviationRatio2sigmaTrackerMapSingleTag;
  typedef SiStripApvGainsRatioWithPreviousIOVTrackerMapSingleTag<3> SiStripApvGainsAvgDeviationRatio3sigmaTrackerMapSingleTag;

  typedef SiStripApvGainsRatioWithPreviousIOVTrackerMapTwoTags<1> SiStripApvGainsAvgDeviationRatio1sigmaTrackerMapTwoTags;
  typedef SiStripApvGainsRatioWithPreviousIOVTrackerMapTwoTags<2> SiStripApvGainsAvgDeviationRatio2sigmaTrackerMapTwoTags;
  typedef SiStripApvGainsRatioWithPreviousIOVTrackerMapTwoTags<3> SiStripApvGainsAvgDeviationRatio3sigmaTrackerMapTwoTags;
  ...
  *************************************************/
  template<int nsigma> class SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapBase : public cond::payloadInspector::PlotImage<SiStripApvGain> {
  public:
    SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapBase() : cond::payloadInspector::PlotImage<SiStripApvGain>( "Tracker Map of ratio (for largest deviation) of SiStripGains with previous IOV" ){
    }
  ...
  template<int nsigma> class SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapSingleTag : public SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapBase<nsigma> {
  public:
    SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapSingleTag(): SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapBase<nsigma>(){
      this->setSingleIov (false);
    }
  };

  template<int nsigma> class SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapTwoTags : public SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapBase<nsigma> {
  public:
    SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapTwoTags(): SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapBase<nsigma>(){
      this->setTwoTags(true);
    }
  };


  typedef SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapSingleTag<1> SiStripApvGainsMaxDeviationRatio1sigmaTrackerMapSingleTag;
  typedef SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapSingleTag<2> SiStripApvGainsMaxDeviationRatio2sigmaTrackerMapSingleTag;
  typedef SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapSingleTag<3> SiStripApvGainsMaxDeviationRatio3sigmaTrackerMapSingleTag;

  typedef SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapTwoTags<1> SiStripApvGainsMaxDeviationRatio1sigmaTrackerMapTwoTags;
  typedef SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapTwoTags<2> SiStripApvGainsMaxDeviationRatio2sigmaTrackerMapTwoTags;
  typedef SiStripApvGainsRatioMaxDeviationWithPreviousIOVTrackerMapTwoTags<3> SiStripApvGainsMaxDeviationRatio3sigmaTrackerMapTwoTags;
  ...
  *************************************************/
  ...
  public:
    SiStripApvGainsComparatorSingleTag () : SiStripApvGainsComparatorBase (){
      setSingleIov( false );
    }
  };
  ...
  public:
    SiStripApvGainsComparatorTwoTags () : SiStripApvGainsComparatorBase (){
      setTwoTags( true );
    }
  };
  ...
  public:
    SiStripApvGainsValuesComparatorBase () : cond::payloadInspector::PlotImage<SiStripApvGain>( "Comparison of SiStrip APV gains values" ){
    }
  ...
  public:
    SiStripApvGainsValuesComparatorSingleTag () : SiStripApvGainsValuesComparatorBase () {
      setSingleIov( false );
    }
  };
  ...
  public:
    SiStripApvGainsValuesComparatorTwoTags () : SiStripApvGainsValuesComparatorBase () {
      setTwoTags( true );
    }
  };
  ...
  public:
    SiStripApvGainsRatioComparatorByRegionBase () : cond::payloadInspector::PlotImage<SiStripApvGain>( "Module by Module Comparison of SiStrip APV gains" ),
      m_trackerTopo{StandaloneTrackerTopology::fromTrackerParametersXMLFile(edm::FileInPath("Geometry/TrackerCommonData/data/trackerParameters.xml").fullPath())}
    {
    }
  ...
  public:
    SiStripApvGainsRatioComparatorByRegionTwoTags () : SiStripApvGainsRatioComparatorByRegionBase (){
      setTwoTags( true );
    }
  };
  ...
  *************************************************/
  ...
  public:
    SiStripApvGainsComparatorByRegionBase() : cond::payloadInspector::PlotImage<SiStripApvGain>( "SiStripGains Comparison By Region" ),
      m_trackerTopo{StandaloneTrackerTopology::fromTrackerParametersXMLFile(edm::FileInPath("Geometry/TrackerCommonData/data/trackerParameters.xml").fullPath())}{
    }
  ...
  public:
    SiStripApvGainsComparatorByRegionSingleTag() : SiStripApvGainsComparatorByRegionBase (){
      setSingleIov( false );
    }
  };
  ...
  public:
    SiStripApvGainsComparatorByRegionTwoTags() : SiStripApvGainsComparatorByRegionBase (){
      setTwoTags( true );
    }
  };
