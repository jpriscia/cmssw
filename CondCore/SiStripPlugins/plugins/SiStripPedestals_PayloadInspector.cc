...
namespace {
  ...
  *************************************************/
  ...
  // inherit from one of the predefined plot class: PlotImage
  template<SiStripPI::OpMode op_mode_> class SiStripPedestalDistributionComparisonBase : public cond::payloadInspector::PlotImage<SiStripPedestals> {

  public:
    SiStripPedestalDistributionComparisonBase() : cond::payloadInspector::PlotImage<SiStripPedestals>("SiStrip Pedestal values comparison"){
    }
  ...
  template<SiStripPI::OpMode op_mode_> class SiStripPedestalDistributionComparisonSingleTag : public SiStripPedestalDistributionComparisonBase<op_mode_>  {
  public:
  ...
  template<SiStripPI::OpMode op_mode_> class SiStripPedestalDistributionComparisonTwoTags : public SiStripPedestalDistributionComparisonBase<op_mode_>  {
  public:
  ...
  typedef SiStripPedestalDistributionComparisonSingleTag<SiStripPI::STRIP_BASED>  SiStripPedestalValueComparisonPerStripSingleTag;
  typedef SiStripPedestalDistributionComparisonSingleTag<SiStripPI::APV_BASED>    SiStripPedestalValueComparisonPerAPVSingleTag;
  typedef SiStripPedestalDistributionComparisonSingleTag<SiStripPI::MODULE_BASED> SiStripPedestalValueComparisonPerModuleSingleTag;

  typedef SiStripPedestalDistributionComparisonTwoTags<SiStripPI::STRIP_BASED>  SiStripPedestalValueComparisonPerStripTwoTags;
  typedef SiStripPedestalDistributionComparisonTwoTags<SiStripPI::APV_BASED>    SiStripPedestalValueComparisonPerAPVTwoTags;
  typedef SiStripPedestalDistributionComparisonTwoTags<SiStripPI::MODULE_BASED> SiStripPedestalValueComparisonPerModuleTwoTags;
