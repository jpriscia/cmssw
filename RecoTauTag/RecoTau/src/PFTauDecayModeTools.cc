...
namespace {
  ...
  constexpr entry dmTranslatorMap[] = {
    ...
    {"twoProng0Pi0", reco::PFTau::kTwoProng0PiZero},
    {"twoProng1Pi0", reco::PFTau::kTwoProng1PiZero},
    {"twoProng2Pi0", reco::PFTau::kTwoProng2PiZero},
    ...
    {"fourProng0Pi0", reco::PFTau::kFourProng0PiZero},
    {"fourProng1Pi0", reco::PFTau::kFourProng1PiZero},
    {"fourProng2Pi0", reco::PFTau::kFourProng2PiZero},
